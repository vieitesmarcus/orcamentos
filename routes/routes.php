...
return [
    ...
    "GET|/despesas/{ano}/{mes}"       => ReceitaApiController::class,          //traz em detalhes tudo do ano e mes
    "GET|/despesas/{ano}/{mes}/{dia}" => ReceitaApiController::class,          // traz em detalhes 
